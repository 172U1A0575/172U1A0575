...
public class Demo1 {
	...
	public static void main(String[] args) {
		...
		s3 = s3.intern();
		System.out.println("s3 = " + s1 + " s3 memory is " + System.identityHashCode(s3));
		...
		System.out.println("s3.asubstring(1,4) : " + s3.substring(1,4));
		String s5 = "hello hi good afternoon, I know java, but please be patient";
		String s6[] = s5.split(" ");
		for (int i = 0;i < s6.length; i++) {
			System.out.println(s6[i].toUpperCase());
		}
		String s7="                  heyyy I am message                     ";
